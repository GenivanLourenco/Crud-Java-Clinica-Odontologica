...
public class CadastroFuncionario extends JFrame {
	...
	public CadastroFuncionario() {
		...
		setIconImage(Toolkit.getDefaultToolkit()
				.getImage(CadastroFuncionario.class.getResource("/guardar/cadeira-de-dentista.png")));
		...
		lblNewLabel_1 = new JLabel("Cadastro de Funcion\u00E1rio");
		...
		JLabel lblCro = new JLabel("Matricula:");
		lblCro.setFont(new Font("Segoe UI", Font.PLAIN, 12));
		lblCro.setBounds(459, 156, 69, 14);
		...
		btnCadastrar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					...
					String sql = "insert into funcionario (nome, cpf, rg, nascimento, genero, cro, telefone, usuario, senha, cep, endereco, bairro, cidade, uf  ) value (?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
					...
					stmt.setString(14, (String) cboUf.getSelectedItem());
		...
		btnSair.setBounds(222, 405, 97, 23);
